...
Um das Resultat nicht von den zufällig gezogenen Daten abhängig zu machen, müssen wir diesen Vorgangmehrere Male (hier meist 400-mal) wiederholen. Damit werden wir Bias und Varianz visualisieren und den MISE annähern, um daraus weitere Erkenntnisse abzuleiten
...
```{r}
#x_points <- seq(from = -3, to = 3, length.out = 1e5)
#plot(x_points, pdfs$Cauchy(x_points))
