...
get_kde <- function(h, Kernel, data) {
    stopifnot('Kernel needs to be a Kernel object, a function or the name of a Kernel in `kernels`.' = is_Kernel(Kernel) || is.function(Kernel) || (Kernel %in% names(kernels)))
